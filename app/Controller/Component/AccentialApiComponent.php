...
class AccentialApiComponent extends Component {
    ...
    /**
     * Sobe todas imagens da company que sejam relacionadas com configurações
     * @param type $folder
     * @param type $fileData
     ...
     * @return string
     */
    public function uploadAnyPhotoCompany($folder = null, $fileData, $recursive = false) {
    ...
    /**
     * Ao criar nova company iserimos um diretorio para a mesma em nosso servidor
     * @param type $companyId
     */
    public function createCompanyDir($companyId) {
        ...
        $dir = "/jezzyuploads/company-" . $companyId;
        $dirConfig = "/jezzyuploads/company-" . $companyId . "/config";
        $dirOffer = "/jezzyuploads/company-" . $companyId . "/offers";
        $dirServices = "/jezzyuploads/company-" . $companyId . "/services";
    ...
    public function uploadAnyPhotos($folder = null, $fileData, $companyId, $recursive = false) {
        ...
        //$destination_path = "jezzyuploads/company-".$companyId."/config/";
        $destination_path = "uploads/company-99999/offers/";
        $destination_file = $destination_path.$fileData['name'];
        
        $file = $myFile['tmp_name'];
		//$fileOriginal = $myFile['tmp_name'];
        $fileThumb = $myFile['tmp_name'];
		...
		//
		$originalImage = new Imagick($file);
		//
