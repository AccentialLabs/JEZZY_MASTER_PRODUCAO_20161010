            ...
            <div class="container-fluid">
                ...
                <div id="navbar" class="navbar-collapse collapse">
                    <ul class="nav navbar-nav navbar-right">
                        <li><a href="#" id="fancy-name-comp"><?php echo $this->Session->read('CompanyLoggedIn.Company.fancy_name'); ?> <div class="badge" id="notification-counter"></div></a></li>
                        <?php
                    ...
                    <div id="menuBusinessIcon">
                        <ul class="nav nav-sidebar">
                            ...
                            <li class="<?php echo $title_for_layout == "Produtos" ? "active" : ""; ?>">
                                <?php echo $this->Html->link('<span class="glyphicon glyphicon-tag"></span>', '/masterProduct', array('class' => 'product', 'escape' => false)); ?>
                            </li>
