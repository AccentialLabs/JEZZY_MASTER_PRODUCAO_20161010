...
<div class="row marginTop30 endFormLine">
    ...
    <div class="col-md-3">
        ...
        <div class="form-group">
            ...
            <div class="btn-group helper-field" data-toggle="buttons" id="divParcelOffer">
                ...
                <input type="number" name="data[Offer][parcel_percentage]" class="form-control width50Porcento" id="parcelOfferPercentage" placeholder="% juros" value="<?php //$offer['parcels_impost_value']; ?>">
    ...
    <div class="col-md-3">
		...
		<div class="col-md-12 help-icon">
			<img src="../img/jezzy_icons/help-icon.png" />
		</div>
    </div>
</div>
